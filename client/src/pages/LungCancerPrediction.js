            ...
            {file.name ? (
                ...
                <div className="grid place-items-center">
                    ...
                    <div className="grid place-items-center py-5">
                        <div className="flex flex-row text-5xl font-bold text-white">Lung Cancer Prediction</div>
                        <div className='bg-blue-500 h-1 w-36 my-2 rounded-lg'></div>
                    </div>

                    <div className="py-6">
                        <input {...getInputProps()} data-testid="upload-image" />
                        <h2 className='text-center text-3xl py-5 text-white'>Choose a file</h2>
