    ...
    <div className="md:mx-28 mx-4 text-white py-10">
      <div className="md:grid md:grid-cols-2 items-center">
        <div className="">
          ...
          <p className="text-xl py-4 tracking-wider text-justify">About the web app</p>
      ...
      <div className="md:grid md:grid-cols-2 pt-12 items-center">
        ...
        <div className="">
          ...
          <ul className="text-xl">
            ...
            <li className="list-disc">A web app where you can check wether you have Lung Cancer or Not.</li>
          </ul>
        </div>
      </div>
    </div>
